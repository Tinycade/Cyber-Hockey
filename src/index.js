...
{
  ctx.font = '35px serif';
  ctx.fillText("Cyber-Hockey", canvas.width / 2, canvas.height * 0.4);

  ctx.font = '25px serif';
  ctx.fillText("Move your paddles onto the red squares to start", canvas.width / 2, (canvas.height / 2));
}
...
function CheckMarkerLocations()
{
  ...
  var Xdiff2 = wall2.center.x - (canvas.width * 0.85 + 30);
